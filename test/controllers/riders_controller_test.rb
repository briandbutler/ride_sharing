...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post riders_url, params: { rider: { home: @rider.home, name: @rider.name, work: @rider.work } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { home: @rider.home, name: @rider.name, work: @rider.work } }
